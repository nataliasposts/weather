...
export default function CurrentWeather() {
  ...
  const { currentWeather, day, dayNum, month, months, time, weeks } =
  ...
  useEffect(() => {
    setInterval(() => {
      ...
      dispatch(
        updateState({ stateName: "month", value: months[date.getMonth()] })
      );
            ...
            <div className="main-temp">
              <img
                ...
                src={
                  ...
                  `/icons/${currentWeather?.data.weather[0].icon}.png`
                }
                alt="Icon"
              />
              <div>
