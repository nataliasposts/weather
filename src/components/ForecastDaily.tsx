            ...
            <div className="icon-cont">
              ...
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  `/icons/${
                    iconsNight[0] ? iconsNight[0][0] ?? "01n" : "01n"
                  }.png`
                }
                alt="forecastIcon"
              />
            ...
            <div className="icon-cont">
              ...
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  `/icons/${
                    iconsNight[1] ? iconsNight[1][0] ?? "01n" : "01n"
                  }.png`
                }
                alt="forecastIcon"
              />
            ...
            <div className="icon-cont">
              ...
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  `/icons/${
                    iconsNight[2] ? iconsNight[2][0] ?? "01n" : "01n"
                  }.png`
                }
                alt="forecastIcon"
              />
            ...
            <div className="icon-cont">
              ...
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  `/icons/${
                    iconsNight[3] ? iconsNight[3][0] ?? "01n" : "01n"
                  }.png`
                }
                alt="forecastIcon"
              />
            ...
            <div className="icon-cont">
              ...
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  `/icons/${
                    iconsNight[4] ? iconsNight[4][0] ?? "01n" : "01n"
                  }.png`
                }
                alt="forecastIcon"
              />
            ...
            <div className="icon-cont">
              ...
              <img
                ...
                src={
                  process.env.PUBLIC_URL +
                  `/icons/${
                    iconsNight[5] ? iconsNight[5][0] ?? "01n" : "01n"
                  }.png`
                }
                alt="forecastIcon"
              />
